...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/slick-theme.css">
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/mecanica2.css">
	<?php echo link_tag('js/assets/global/plugins/icheck/skins/all.css'); ?>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/FileSaver.js/1.3.3/FileSaver.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/html2canvas/0.4.1/html2canvas.min.js"></script>

<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-122311717-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-122311717-1');
</script>
