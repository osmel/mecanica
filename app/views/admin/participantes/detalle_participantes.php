						...
						<table id="tabla_detalle_participantes" class="display table table-striped table-bordered table-responsive" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<th class="text-center cursora" width="10%">Redes</th>
									
									<th class="text-center cursora" width="10%">cadena</th>	
									...
									<th class="text-center cursora" width="10%">Num. Tienda </th>
									<th class="text-center cursora" width="10%">Producto</th>
									<th class="text-center cursora" width="10%">Presentacion</th>
