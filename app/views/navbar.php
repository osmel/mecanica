...
<nav class="navbar navbar-fixed-top menu-top" role="navigation">
	...
	<div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo base_url(); ?>">
      	<!-- <img src="<?php echo base_url(); ?>img/ley.png"> --> INICIO
      </a>
	...
	<div class="collapse navbar-collapse" id="main-navbar">
		<ul class="nav navbar-nav navegacion" id="menu_opciones">
			...
			<li>
								...
								<?php if ($this->session->userdata('session_participante') == true) { ?>
								<li>
									<a href="<?php echo base_url(); ?>ingresar_usuario/<?php echo $this->session->userdata('mecanica'); ?>" class="">PARTICIPAR</a> 
								</li>
								...
								<?php if ($this->session->userdata('session_participante') == true) { ?>
					             ...
					             <?php }else{ ?>
									<!-- 	<li>								
									<a href="<?php echo base_url(); ?>registro_usuario/<?php echo base64_encode(1); ?>" class="">CREAR CUENTA</a>
								</li> -->
