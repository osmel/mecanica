...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyCKn40mIGee_JEhtTN2GnlBZianlezDA6s'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	function create_map()
	{
		...
		if ($this->maps_loaded == 0)
		{
			...
			$this->output_js .= '
			<script type="text/javascript" src="/js/localizador/milocalizador.js"></script>
			'; 
		...
		if ($this->cluster) {
			//$this->miimagen = "images/m";
			$this->output_js_contents .= '
			var clusterOptions = {
				imagePath: "img/images_localizador/m"'.', 
