...
//listado de los participantes de cupones

 public function participante_cupones(){
   ...
   if ( $this->session->userdata('session') !== TRUE ) {
      ...
      switch ($id_perfil) {    
        case 1:
            $this->load->view( 'admin/participantes/cupones');
          break;
        case 2:
        case 3:
        case 4:
  ...
  public function procesando_participante_cupones(){

    $data=$_POST;
    $busqueda = $this->modelo->buscador_participantes_cupones($data);
    echo $busqueda;
  } 
