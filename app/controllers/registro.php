...
class Registro extends CI_Controller {
	...
	public function tijuana(){
		$this->load->view( 'activaciones/tijuana' );
	}

	public function cdmx(){
		$this->load->view( 'activaciones/cdmx' );
	}

	public function guadalajara(){
		$this->load->view( 'activaciones/guadalajara' );
	}

	public function monterey(){
		$this->load->view( 'activaciones/monterey' );
	}
...
/////////// cupones///mecanica2 //////////////////////
	...
	private function set_barcode($code)	{
		   ...
		   //$file = Zend_Barcode::draw('code128', 'image', array('text' => $code, 'factor'=>3.98,   ), array());
		   $file = Zend_Barcode::draw('code128', 'image', array('text' => $code, 'drawText'=>false, 'factor'=>3.98,   ), array());
		   //$code = time().$code;
