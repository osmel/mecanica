function Spin2WinWheel() {
  ...
  var xmlns = "http://www.w3.org/2000/svg",
    ...
    setInitPos = function() {
      ...
      TweenMax.set(peg, {
        ...
        y: centerY - wheelRadius - (peg.getBBox().height / 10),
    ...
    drawSegments = function() {
      ...
      for (var i = 0; i < numSegments; i++) {
        ...
        g.appendChild(p);
        //g.appendChild(t);
        //CON ESTO OCULTAMOS LOS GAJOS DE LAS DIVISIONES
        //wheel.appendChild(g);
        TweenMax.set(p, {
 ...
 getTrigger = function(){
         return function(){
          playBTn = document.getElementById("spinBtn");
    playBTn2 = document.getElementById("spinBtn2");
      
          rotateCD = new TweenMax.to(wheel, .3, {onUpdate:throwUpdate, rotation:"360", ease:Linear.easeNone,repeat:-1,paused:true,end:getProbabilityClickSpin()}).timeScale(0);
          rotateCD.play();
          TweenLite.to(rotateCD,2,{timeScale:1});   
          aBtn1= document.getElementById("girasdos2"); 
          aBtn2= document.getElementById("girasdos");
          aBtn1.style.display = 'inline-block';
          aBtn2.style.display = 'inline-block';
    ...
    playBTn.style.display = 'none';
    playBTn2.style.display = 'none';
    TweenLite.to(rotateCD,2,{timeScale:0,onUpdate:throwUpdate,onComplete:function(){ 
    this.pause();
    spinComplete();
