			...
			success: function(data){
				...
				if(data != true){
					...
					jQuery('html,body').animate({
						...
						window.location.href = '/7up/admin';
				}
			}
		});
		return false;
...
jQuery('#tabla_acceso_usuario').dataTable( {
	  ...
	  "pagingType": "full_numbers",
		...
		"serverSide": true,
		"ajax": {
	            	"url" : "/7up/procesando_historico_accesos",
	         		"type": "POST",
...
jQuery('#tabla_listado_completo').dataTable( {
	  ...
	  "pagingType": "full_numbers",
		...
		"serverSide": true,
		"ajax": {
	            	"url" : "/7up/procesando_participantes_unico",
	         		"type": "POST",
...
jQuery('#tabla_participantes').dataTable( {
	  "pagingType": "full_numbers",
		...
		"serverSide": true,
		"ajax": {
	            	"url" : "/7up/procesando_participantes",
	         		"type": "POST",
	     },   
		"language": {  //tratamiento de lenguaje
			"lengthMenu": "Mostrar _MENU_ registros por página",
...
jQuery('#tabla_detalle_participantes').dataTable( {
	  ...
	  "pagingType": "full_numbers",
		...
		"serverSide": true,
		"ajax": {
	            	"url" : "/7up/procesando_detalle_participantes",
	         		"type": "POST",
	         		"data": function ( d ) {
	         		 	d.id = jQuery('#id').val();  
	         		 },
...
jQuery('#tabla_participantes_cupones').dataTable( {
	  "pagingType": "full_numbers",
		...
		"serverSide": true,
		"ajax": {
	            	"url" : "/7up/procesando_participante_cupones",
	         		"type": "POST",
	     },   
		"language": {  //tratamiento de lenguaje
			"lengthMenu": "Mostrar _MENU_ registros por página",
...
jQuery('#tabla_bitacora_participante').dataTable( {
	  ...
	  "pagingType": "full_numbers",
		...
		"serverSide": true,
		"ajax": {
	            	"url" : "/7up/procesando_historico_participantes",
	         		"type": "POST",
...
jQuery('#tabla_cat_premios').dataTable( {
    ...
    "serverSide": true,
    "ajax": {
                "url" : "/7up/procesando_cat_premios",
              "type": "POST",
...
jQuery('#tabla_cat_imagenes').dataTable( {
    ...
    "serverSide": true,
    "ajax": {
                "url" : "/7up/procesando_cat_imagenes",
              "type": "POST",
...
jQuery('#tabla_cat_litrajes').dataTable( {
    ...
    "serverSide": true,
    "ajax": {
                "url" : "/7up/admin/procesando_cat_litrajes",
              "type": "POST",
...
/////////////////////////////////Estados///////////////////////
  ...
  jQuery('#tabla_cat_estados').dataTable( {
    ...
    "serverSide": true,
    "ajax": {
                "url" : "/7up/procesando_cat_estados",
              "type": "POST",
